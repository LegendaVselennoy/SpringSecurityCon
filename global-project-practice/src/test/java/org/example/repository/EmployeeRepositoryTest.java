...
class EmployeeRepositoryTest {
    ...
    public void updateEmployee() {
        ...
        Employee savedEmployee = employeeRepository.findById(employee.getEmployee_id()).get();
    ...
    public void employeeFindByIdThenReturnEmployee() {
        Employee employeeDB = employeeRepository.findById(employee.getEmployee_id()).orElse(null);
    ...
    public void employeeDeleteThenReturnEmployee() {
        ...
        Optional<Employee> employeeDB = employeeRepository.findById(employee.getEmployee_id());
